// ============================================================
// NOTIFICATIONS.JS - Single Notification Controller
// ============================================================
...
async function getUnreadNotificationsCount() {
    ...
    try {
        ...
        console.error("getUnreadNotificationsCount error:", e);
        return { total: 0, likes: 0, comments: 0, follows: 0 };
    }
}
        ...
        html += `
            <div onclick="${clickAction}" style="display:flex;align-items:center;gap:12px;padding:12px 16px;border-bottom:1px solid #1a1a1a;cursor:pointer;">
                ...
                <div style="flex:1;">
                    ...
                    ${postImage ? `<div style="margin-top:5px;"><img src="${postImage}" style="width:40px;height:40px;border-radius:8px;object-fit:cover;"></div>` : ''}
...
if (window.USER) {
    setInterval(() => {
        if (window.USER) loadNotificationCounts();
    }, 10000);
}
...
window.updateActivityBadge = updateActivityBadge;
